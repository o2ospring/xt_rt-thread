...
#define XXX_TIMX_IRQn                TIM2_IRQn                          // 定时器中断通道 (不中断则屏蔽)//
#define XXX_TIMX_PRE_INT_PRIO        0                                  // 定时器抢占中断优先级(.则屏蔽)//
#define XXX_TIMX_SUB_INT_PRIO        0                                  // 定时器响应中断优先级(.则屏蔽)//
#define XXX_TIMX_IRQHandler          TIM2_IRQHandler                    // 中断向量函数   (不中断则屏蔽)*/
...
#define XXX_PWM1_CCR                 CCR1                               /* PWM1 XXX_TIMX->XXX_PWM1_CCR  */ //占空比
#define XXX_PWM1_TIM_CHANNEL         TIM_CHANNEL_1                      /* PWM1 所在定时器通道          */
...
#define XXX_PWM2_CCR                 CCR2                               /* PWM2 XXX_TIMX->XXX_PWM2_CCR  */ //占空比
#define XXX_PWM2_TIM_CHANNEL         TIM_CHANNEL_2                      /* PWM2 所在定时器通道          */
...
#define XXX_PWM3_CCR                 CCR3                               /* PWM3 XXX_TIMX->XXX_PWM3_CCR  */ //占空比
#define XXX_PWM3_TIM_CHANNEL         TIM_CHANNEL_3                      /* PWM3 所在定时器通道          */
...
#define XXX_PWM4_CCR                 CCR4                               /* PWM4 XXX_TIMX->XXX_PWM4_CCR  */ //占空比
#define XXX_PWM4_TIM_CHANNEL         TIM_CHANNEL_4                      /* PWM4 所在定时器通道          */
